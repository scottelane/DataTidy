...
{
    /// <summary>
    /// Converts a secondary data source DataColumn to and from a string to support configuring data columns in a property grid.
    /// </summary>
    public class SecondaryDataSourceFieldConverter : TypeConverter
    {
        /// <summary>
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            {
                ISecondaryDataSourceFieldsProvider provider = (ISecondaryDataSourceFieldsProvider)context.Instance;
                List<DataTableField> fields = provider.GetSecondaryDataSourceFields();
        ...
        {
            ISecondaryDataSourceFieldsProvider provider = (ISecondaryDataSourceFieldsProvider)context.Instance;
            return new StandardValuesCollection(provider.GetSecondaryDataSourceFields());
        }
    }
}
