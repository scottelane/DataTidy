...
namespace ScottLane.DataTidy.Dynamics365
{
    ...
    /// </remarks>
    public class Dynamics365SetStateFieldValueCollectionEditor : FieldValueCollectionEditor
    {
        /// <summary>
        /// Initialises a new instance of the Dynamics365SetStateFieldValueCollectionEditor class that creates objects with the specified type.
        /// </summary>
        /// <param name="type">The type.</param>
        public Dynamics365SetStateFieldValueCollectionEditor(Type type) : base(type)
        { }
        ...
        {
            return new Type[] { typeof(Dynamics365SetStateDataSourceValue), typeof(Dynamics365SetStateUserProvidedValue), typeof(Dynamics365SetStateLookupValue) };
        }
        ...
        protected override string GetAddButtonDisplayName(string typeName)
        {
            ...
            if (typeName == nameof(Dynamics365SetStateDataSourceValue))
            {
                friendlyName = Properties.Resources.DataSourceValueName;
            }
            else if (typeName == nameof(Dynamics365SetStateUserProvidedValue))
            {
                friendlyName = Properties.Resources.UserProvidedValueName;
            }
            else if (typeName == nameof(Dynamics365SetStateLookupValue))
            {
